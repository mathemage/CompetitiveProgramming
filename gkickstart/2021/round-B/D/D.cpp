/* ========================================
   ...
   * Last Modified : Mon 19 Apr 2021 03:38:35 AM CEST
   * Created By : Karel Ha <mathemage@gmail.com>
   * URL : https://codingcompetitions.withgoogle.com/kickstart/round/0000000000435a5b/000000000077a885
   * Points/Time :
   * Total/ETA :
   * Status :
   * S AC TLE !!
...
void solve() {
  ...
  REP(j,Q) {
    ...
    while (Cj!=1) {
      ll par=parent[Cj];
      if (Wj>=limits[MP(min(Cj,par), max(Cj,par))] ) {
        cost = __gcd(cost, tolls[MP(min(Cj,par), max(Cj,par))]); 
      }
      Cj=par;
    }
