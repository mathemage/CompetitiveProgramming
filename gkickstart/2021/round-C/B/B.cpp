/* ========================================
   ...
   * Last Modified : Sun 23 May 2021 02:13:28 PM CEST
   * Created By : Karel Ha <mathemage@gmail.com>
   * URL : https://codingcompetitions.withgoogle.com/kickstart/round/0000000000435c44/00000000007ec1cb
   * Points/Time :
   * Total/ETA : 7+12 pts
   * Status : S AC AC !!!!!!!!!!!!!!!!!!!!!!!
   ==========================================*/
...
void solve() {
  ...
  FOR(L,1,G) {
    ...
    if (RHS%L==0) {
      result++;
      LINESEP1; MSG(RHS); MSG(L); MSG(RHS/L); MSG(result);
    }
  }
