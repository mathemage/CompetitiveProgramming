/* ========================================
   ...
   * Last Modified : Thu 12 Aug 2021 12:35:27 AM CEST
  ...
  FOR(sum,1,MX) {
    FOR(ri,0,MX) {
      FOR(pi,0,sum-ri) {
        ...
        if (ri-1>=0 && umax(bestVal[ri][pi][si], bestVal[ri-1][pi][si] + probS)) {
          bestMove[ri][pi][si]='R';
        }
        if (pi-1>=0 && umax(bestVal[ri][pi][si], bestVal[ri][pi-1][si] + probR)) {
          bestMove[ri][pi][si]='P';
        }
        if (si-1>=0 && umax(bestVal[ri][pi][si], bestVal[ri][pi][si-1] + probP)) {
          bestMove[ri][pi][si]='S';
        }
