/* ========================================
   ...
   * Last Modified : Sun 14 Nov 2021 06:54:52 AM CET
...
void solve() {
  ...
  auto consec = [&](ll pos, ll pos2) {
    if (!bounded(pos,N) || !valid[pos]) { return false; }
    if (!bounded(pos2,N) || !valid[pos2]) { return false; }
