/* ========================================
   ...
   * Last Modified : Ne 13. února 2022, 23:36:44
   * Created By : Karel Ha <mathemage@gmail.com>
   * URL : https://codingcompetitions.withgoogle.com/kickstart/round/00000000004349ac/0000000000434880#problem
   * Points/Time :
   * = 2m
   *
   * Total/ETA :
   * Status :
   * S AC AC ^_^ <- (but can't verify harder testcaes :-/)
   *
   ==========================================*/
