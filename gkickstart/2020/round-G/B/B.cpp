/* ========================================
   ...
   * Last Modified : Fri 15 Oct 2021 03:43:02 PM CEST
   * Created By : Karel Ha <mathemage@gmail.com>
   * URL : https://codingcompetitions.withgoogle.com/kickstart/round/00000000001a0069/0000000000414a23
   * Points/Time :
   * = 4m
   *
   * Total/ETA : 7+8 pts
...
void solve() {
  ll N; cin >> N;
  vector<vector<ll>> C(N, vector<ll>(N)); cin >> C;
  MSG_VEC_VEC(C); LINESEP1;

  unordered_map<ll, ll> diagSums;
  REP(r,N) {
    REP(c,N) {
      diagSums[r-c]+=C[r][c];
    }
