/* ========================================
   ...
   * Last Modified : Tue 13 Apr 2021 02:53:45 PM CEST
   ...
   * Status :
   * S WA -
   * S AC AC (bug: read the whole input first, peaks needs to look at next values H[i+1])
   *
   ==========================================*/
...
void solve() {
  ...
  REP(i,N) {
    if (i && i!=N-1 && H[i]>H[i-1] && H[i]>H[i+1]) {
      result++;
    }
  }
