...
const int TRUNC=1000;
// const int TRUNC=1500;
// const int TRUNC=2500;
// const int TRUNC=300;
// const int TRUNC=350;
// const int TRUNC=600;
...
void solve() {
  ...
  int RL=R-L; int DU=D-U;

  MINUPDATE(L,TRUNC); MINUPDATE(U,TRUNC);
  MINUPDATE(RL,TRUNC); MINUPDATE(DU,TRUNC);

  R=L+RL; D=U+DU; 
  MINUPDATE(W, R+1); MINUPDATE(H, D+1);
