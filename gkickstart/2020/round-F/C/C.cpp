/* ========================================
   ...
   * Last Modified : Fri 17 Sep 2021 01:05:54 AM CEST
...
void solve() {
  ...
  vector<vector<int>> RP(C, vector<int>(2)); cin >> RP;
  MSG_VEC_VEC(RP); LINESEP1;
  ...
  if (Ra==2 && Pa==2) {
    ...
    if (Rb==2 && Pb==2) {
      ...
      bool blockedCenter=0;
      for (auto & room: RP) {
        if (room[0]==2 && room[1]==2) {
          blockedCenter=1;
          break;
        }
      }
