/* ========================================
   ...
   * Last Modified : Thu 16 Sep 2021 12:08:52 AM CEST
   * Created By : Karel Ha <mathemage@gmail.com>
   * URL : https://codingcompetitions.withgoogle.com/kickstart/round/000000000019ff48/00000000003f4b8b
   * Points/Time :
   * = 17m
   *
   * Total/ETA : 6+10 pts
...
void solve() {
  ...
  pair<ll, ll> prevAvail={CLEAN, CLEAN};
  pair<ll, ll> SE;
  REP(_,N) {
    cin >> SE.OP >> SE.CL;
    if (prevAvail.CL<=SE.OP) {
      prevAvail.OP=SE.OP;
      prevAvail.CL=prevAvail.OP+K;
      result++;
    } else {
      ll times=( (SE.CL-1)-(prevAvail.CL-1) +K-1 ) / K;
      prevAvail.OP+=times*K;
      prevAvail.CL+=times*K;
      result+=times;
    }
  }
