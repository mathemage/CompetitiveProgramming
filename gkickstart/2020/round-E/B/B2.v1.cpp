/* ========================================
   ...
   * Last Modified : Tue 17 Aug 2021 11:58:13 PM CEST
   * Created By : Karel Ha <mathemage@gmail.com>
   * URL : https://codingcompetitions.withgoogle.com/kickstart/round/000000000019ff47/00000000003bef73#problem
   * Points/Time :
   * = 16m :-/
   *
   * Total/ETA : 15m
...
void solve() {
  ...
  MSG(N); MSG(A); MSG(B); MSG(C); LINESEP1;
  ...
  ll leftOne = (A-C==0 && C/2==0);

  cout << vector<int>(A-C,N-1);
  cout << vector<int>((C+leftOne)/2,N);
  cout << vector<int>(N-A-B+C,1);
  cout << vector<int>((C+1-leftOne)/2,N);
  cout << vector<int>(B-C,N-1);
  cout << endl;
}
