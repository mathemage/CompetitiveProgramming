/* ========================================
   ...
   * Last Modified : Tue 17 Aug 2021 01:31:16 AM CEST
   * Created By : Karel Ha <mathemage@gmail.com>
   * URL : https://codingcompetitions.withgoogle.com/kickstart/round/000000000019ff47/00000000003bef73
   * Points/Time :
   *      =   37m
   * +17m =   54m
   * + 8m = 1h 2m [editorial]
...
void solve() {
  ...
  if (N>2) {
    REP(i,A-1) {
      result[i] = i>=(A-1)-(C-1)?3:2; // TODO
    }
    REP(j,B-C) {
      result[N-1-j]=2; // TODO
    }
    result[N-1-(B-C)]=3; // TODO
  }
  cout << result << endl;
}
