/* ========================================
   ...
   * Last Modified : Tue 18 May 2021 09:07:52 PM CEST
...
//         MSG(rTop);
        ...
        letters.insert(chTop);
        letters.insert(chBot);

        if (chTop!=chBot) {
//           MSG(chTop); MSG(chBot);
          prereq[chTop].insert(chBot);
        }
//         LINESEP1;
      }
//       LINESEP1;
...
//   LINESEP1;
  ...
  map<char, bool> used;
//   for (auto & ch: letters) { used[ch]=false; }
