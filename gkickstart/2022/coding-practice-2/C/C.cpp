/* ========================================
   ...
   * Last Modified : Wed 29 Jun 2022 07:39:13 PM CEST
   * Created By : Karel Ha <mathemage@gmail.com>
   * URL : https://codingcompetitions.withgoogle.com/kickstart/round/00000000008f4a94/0000000000b54d3b
   * Points/Time :
   * = 18 m :-/
   *
   * Total/ETA : 6+8 pts
...
void solve() {
  ...
  auto isPali = [&](ll L, ll R) {
    MSG(prefCnt);
    ll nOdds=0;
    REP(i,MX) {
      ll count = prefCnt[R][i];
      if (L-1>=0) {
       count -= prefCnt[L-1][i];
      }
      nOdds += count%2;
