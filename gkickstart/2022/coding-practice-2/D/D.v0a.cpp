/* ========================================
   ...
   * Last Modified : Thu 30 Jun 2022 07:23:36 PM CEST
...
void solve() {
  ...
  for (auto & ch: expr) {
    ...
    if (SZ(posVowels)>=5) {
      ...
      ll len1=posVowels[last-3]-posVowels[last-4];
      string w1=expr.substr(posVowels[last-3], len1);

      ll len2=posVowels[last]-posVowels[last-1];
