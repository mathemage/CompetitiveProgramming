...
/* ========================================
   ...
   * Last Modified : Čt 24. února 2022, 23:47:07
   * Created By : Karel Ha <mathemage@gmail.com>
   * URL : https://codingcompetitions.withgoogle.com/kickstart/round/00000000008f4332/0000000000941e56#problem
   * Points/Time :
   * = 4m
   *
   * Total/ETA : 6+8 pts
...
void solve() {
  ...
  ll Ci;
  ll H = 0LL;
  unordered_map<ll, ll> candidates;
  ll nCandidates=0;
  REP(_,N) {
    cin >> Ci;
    umin(Ci,N);
