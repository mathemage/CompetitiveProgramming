...
/* ========================================
   ...
   * Last Modified : Pá 18. února 2022, 00:11:26
   ...
   * Status :
   * S AC TLE :-/
   * S AC TLE :-/ <- std::distance() on set iterators in O(n) :-(
   *
   ==========================================*/
...
//     ll cnt = SZ(st)-(it - st.begin());
    ll cnt = SZ(st)-std::distance(st.begin(), it);
    return cnt >= H;
  };
