/* ========================================
   ...
   * Last Modified : Sun 10 Jul 2022 07:27:31 AM CEST
   * Created By : Karel Ha <mathemage@gmail.com>
   * URL : https://codingcompetitions.withgoogle.com/kickstart/round/00000000008caea6/0000000000b76e11
   * Points/Time : 00:26:29
   * Total/ETA : 4+6 pts
   * Status :
   * S AC AC !!! (flash)
   *
...
void solve() {
  ...
  if (len>0) {
    ...
    result += (A[head+l1] + A[head+l2] ) / 2.0;
    MSG(len);
    MSG(head);
    MSG(l1); MSG(A[head+l1]);
    MSG(l2); MSG(A[head+l2]);
  }
