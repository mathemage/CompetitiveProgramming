/* ========================================
   ...
   * Last Modified : Sun 10 Jul 2022 09:20:00 AM CEST
   * Created By : Karel Ha <mathemage@gmail.com>
   * URL : https://codingcompetitions.withgoogle.com/kickstart/round/00000000008caea6/0000000000b76f44
   * Points/Time :
   * 01:55:53
   *
...
void solve() {
  ...
  // TODO remove assert
  for (auto & [ch,positions]: ch2pos) {
    assert(SZ(positions)<=1);
  }

  ll result = 0LL;
  ll pos=ch2pos[S[0]][0];
  for (auto & ch: S) {
    result+=abs(ch2pos[ch][0]-pos);
    pos=ch2pos[ch][0];
  }
