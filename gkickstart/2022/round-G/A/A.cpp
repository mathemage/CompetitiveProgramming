/* ========================================
   ...
   * Last Modified : Sat 15 Oct 2022 02:12:55 PM CEST
   * Created By : Karel Ha <mathemage@gmail.com>
   * URL : https://codingcompetitions.withgoogle.com/kickstart/round/00000000008cb2e1/0000000000c174f2
   * Points/Time :
   * Total/ETA : 4+6 pts
   * Status :
   * S AC AC
...
void solve() {
  ...
  ll result = 0LL;
  REP(day,N) {
    result += max(0LL, mxPerDays[day]-john[day]);
  }
  cout << result << endl;
}
