/* ========================================
   ...
   ID: mathema6
   TASK: bronze2.v3.linear_editorial_solution
   LANG: C++14

   * File Name : bronze2.v3.linear_editorial_solution.cpp
   * Creation Date : 30-12-2021
   * Last Modified : Thu 30 Dec 2021 11:26:44 PM CET
...
#define PROBLEMNAME "bronze2.v3.linear_editorial_solution"
...
void solve() {
  ...
  REP(i,N) {
    ...
    sumAbsDiff += abs(curD-prevD);
    prevD=curD;
  }
  sumAbsDiff += abs(0-prevD);
