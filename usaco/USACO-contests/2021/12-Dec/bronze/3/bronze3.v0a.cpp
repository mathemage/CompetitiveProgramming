/* ========================================
   ...
   * Last Modified : Sat 18 Dec 2021 03:57:53 PM CET
      ...
      FOR(k,0,K) {
        for (auto & d: {DOWN, RIGHT}) {
          if (r-1>=0 && grid[r-1][c]!='H') {
            ways[r][c][k][d] += ways[r-1][c][k][d];
            if (k-1>=0) {
              ways[r][c][k][d] += ways[r-1][c][k-1][1-d];
            }
          }

          if (c-1>=0 && grid[r][c-1]!='H') {
            ways[r][c][k][d] += ways[r][c-1][k][d];
            if (k-1>=0) {
              ways[r][c][k][d] += ways[r][c-1][k-1][1-d];
            }
          }
        }
      }
