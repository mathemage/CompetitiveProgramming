/* ========================================
   ...
   * File Name : teleport.cxx
   * Creation Date : 28-04-2021
   * Last Modified : Wed 28 Apr 2021 08:04:59 PM CEST
   ...
   * Status :
   * 1/10 WA :-/
   * [testdata] -> bug with not using abs() for initial result (negative dist, messes up MINUPDATE())
   * 10/10 AC -> passed ! :-/
   *
   ==========================================*/
...
void solve() {
  ...
  MINUPDATE(result, abs(x-a)+abs(y-b));
  MSG(abs(x-a)+abs(y-b));

  MINUPDATE(result, abs(y-a)+abs(x-b));
  MSG(abs(y-a)+abs(x-b));
