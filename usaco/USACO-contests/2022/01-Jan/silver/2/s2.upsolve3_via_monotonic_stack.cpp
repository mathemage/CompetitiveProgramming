/* ========================================
   ...
   ID: mathema6
   TASK: s2.upsolve3_via_monotonic_stack
   LANG: C++14

   * File Name : s2.upsolve3_via_monotonic_stack.cpp
   * Creation Date : 11-02-2022
   * Last Modified : Fri 11 Feb 2022 07:36:26 PM CET
   ...
   * Total/ETA :
   * Status :
   * 11/11 ACs (passed) <- yes!!! ultra-fast - 2m44s!
   *
   ==========================================*/

#define PROBLEMNAME "s2.upsolve3_via_monotonic_stack"
