/* ========================================
   ...
   * File Name : s2.brute2.cpp
   * Creation Date : 31-01-2022
   * Last Modified : Mon 31 Jan 2022 10:34:58 PM CET
   * Created By : Karel Ha <mathemage@gmail.com>
   * URL : http://usaco.org/current/index.php?page=viewproblem&cpid=1171
   * Points/Time :
   * Total/ETA :
   * Status :
   * 3/11 ACs, 8/11 TLEs :-/ ^_^
   *
   ==========================================*/

#define PROBLEMNAME "s2.brute2"
