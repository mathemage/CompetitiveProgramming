/* ========================================
   ...
   * File Name : s1.2.upsolve.cpp
   * Creation Date : 23-02-2022
   * Last Modified : Wed 23 Feb 2022 11:43:40 PM CET
   ...
   * Total/ETA :
   * Status :
   * 12/12 ACs!! yes - passed & flash-upsolved!
   *
   ==========================================*/

#define PROBLEMNAME "s1.2.upsolve"
...
void solve() {
  ...
  ll result = INF_LL;
  for (auto & [d, distD]: down) {
    for (auto & [u, distU]: up) {
      if (d>u) {
        continue;
      }

      umin(result, distD+(u-d)+distU);
    }
  }
