/* ========================================
   ...
   * Last Modified : Sat 29 Jan 2022 03:45:38 PM CET
   * Created By : Karel Ha <mathemage@gmail.com>
   * URL : http://usaco.org/index.php?page=viewproblem&cpid=1168
   * Points/Time :
   * Total/ETA :
   * Status :
   * 11/11 ACs (passed & flashed again!! ^_^)
   *
   ==========================================*/
...
bool operator>(die X, die Y) {
  ll Xwins=0LL, Ywins=0LL;
  REP(i,4) {
    REP(j,4) {
      if (X[i]>Y[j]) {
        Xwins++;
...
void solve() {
  vector<ll> AA(4); cin >> AA;
  vector<ll> BB(4); cin >> BB;
  die A = AA;
  die B = BB;
