/* ========================================
   ...
   * File Name : s2.1_brute.cpp
   * Creation Date : 27-02-2022
   * Last Modified : Sun 27 Feb 2022 05:21:52 PM CET
   * Created By : Karel Ha <mathemage@gmail.com>
   * URL : http://usaco.org/index.php?page=viewproblem&cpid=1195
   * Points/Time :
   * Total/ETA :
   * Status :
   * 4/16 ACs, 12/16 TLEs ^_^
   *
   ==========================================*/

#define PROBLEMNAME "s2.1_brute"
...
void solve() {
  ...
  REP(b,1L<<N) {
    ...
    if (xx==xg && yy==yg) {
      result[__builtin_popcountll(b)-1]++;
    }
  }
