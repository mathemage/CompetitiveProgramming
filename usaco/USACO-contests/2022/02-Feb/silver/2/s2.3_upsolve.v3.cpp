/* ========================================
   ...
   * Last Modified : Fri 11 Mar 2022 12:27:22 AM CET
    ...
    REP(b,1LL<<Ns[iN]) {
      ...
      if (iN==0) {
        ...
        for (ll k2 = 0; k+k2 <= N; k2 += 1) {
          if (CONTAINS(xyk2w[0], xg-x)
           && CONTAINS(xyk2w[0][xg-x], yg-y)
           && CONTAINS(xyk2w[0][xg-x][yg-y], k2) ) {
            result[k+k2] += xyk2w[0][xg-x][yg-y][k2];
          }
        }
      }
    }
