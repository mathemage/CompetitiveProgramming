/* ========================================
   ...
   * Last Modified : Wed 19 May 2021 12:13:43 AM CEST
   ...
   * Total/ETA :
   * Status :
   * Incorrect answer on sample input case -- details below <= [extra space?]
   * Incorrect answer on sample input case -- details below <= [no new line?]
   * Incorrect answer on sample input case -- details below <= [extra backspace visible]
   *
   ==========================================*/

#include <algorithm>
#define PROBLEMNAME "1"
...
void solve() {
  vector<long long> nums(7); cin >> nums;
  sort(ALL(nums));
  MSG(nums); LINESEP1;
