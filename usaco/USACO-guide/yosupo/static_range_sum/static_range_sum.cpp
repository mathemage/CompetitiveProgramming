/* ========================================
   ...
   ID: mathema6
   TASK: static_range_sum
   LANG: C++14

   * File Name : static_range_sum.cpp
   * Creation Date : 02-02-2022
   * Last Modified : Wed 02 Feb 2022 10:39:18 PM CET
...
#include <numeric>
#define PROBLEMNAME "static_range_sum"
...
void solve() {
  ...
  vector<ll> pref(N);
  std::partial_sum(ALL(a), pref.begin());
  MSG(pref); LINESEP1;
