/* ========================================
   ...
   * Last Modified : Fri 24 Sep 2021 11:11:06 PM CEST
   * Created By : Karel Ha <mathemage@gmail.com>
   * URL : https://www.facebook.com/codingcompetitions/hacker-cup/2019/round-2/problems/A
   * Points/Time :
   * = 34m
   *
   * Total/ETA : 14/100 pts
   * Status :
   * AC!! yes!!
   *
   ==========================================*/
...
void solve() {
  ...
  bool surrender = K==2 && parity(R[0],C[0])==parity(A,B) && parity(R[1],C[1])==parity(A,B);
  cout << ((surrender)?"Y":"N") << endl;
}
