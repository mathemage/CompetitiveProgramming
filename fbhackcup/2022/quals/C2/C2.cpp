/* ========================================
   ...
   * Last Modified : Sat 27 Aug 2022 06:16:34 PM CEST
   * Created By : Karel Ha <mathemage@gmail.com>
   * URL : https://www.facebook.com/codingcompetitions/hacker-cup/2022/qualification-round/problems/C2
   * Points/Time :
   * Total/ETA : 18 pts
   * Status :
   *
...
void solve() {
  ...
  auto collide = [&](string w) {
    ll len = min(SZ(C), SZ(w));
    return C.substr(0,len) == w.substr(0,len);
  };
#ifdef MATHEMAGE_DEBUG
  assert(collide(C+'.')==true);
  assert(collide(C.substr(0,1))==true);
  assert(collide("abc")==false);
#endif
