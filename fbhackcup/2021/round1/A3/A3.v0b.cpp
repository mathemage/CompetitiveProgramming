/* ========================================
   ...
   * Last Modified : Sun 12 Sep 2021 06:19:43 PM CEST
...
void solve() {
  ...
  for (auto & ch: U) {
    ...
    if (ch=='.') {
      // TODO updates
//       curF += (lastState!=UNDEF && ch!=lastState);  // TODO
      ...
      if (ch!='F') {
        ...
        curF += (lastState!=UNDEF && ch!=lastState);

//         MSG(sumSuffixes); MSG(prevPos); MSG(lastState!=UNDEF && ch!=lastState);
        sumSuffixes += ( (lastState!=UNDEF && ch!=lastState) * (prevPos+1) ) % MOD;
//         MSG(sumSuffixes);
