/* ========================================
   ...
   * Last Modified : Sat 20 Aug 2022 09:50:19 PM CEST
...
//   Y-50.0;
  ...
  ld dist = sqrt(pow(X-50.0, 2) + pow(Y-50.0, 2));
  bool withinDist = (dist <= 50.0);
  MSG(sqrDist);

//   ld angle = pow(X-50.0, 2) + pow(Y-50.0, 2);
//   bool withinAngle = (sqrDist <= pow(50.0,2));
