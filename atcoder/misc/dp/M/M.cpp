/* ========================================
   ...
   * Last Modified : Thu 21 Oct 2021 12:26:46 AM CEST
...
void solve() {
  ...
  for (auto & ai: a) {
    ...
    FORD(s,K,1) {
      MSG(s); MSG(prefSum[s-1]); MSG((s-ai-1>=0 ? prefSum[s-ai-1] : 0));
      dp[s]+=prefSum[s-1] - (s-ai-1>=0 ? prefSum[s-ai-1] : 0);
      dp[s]%=MOD;
    }
