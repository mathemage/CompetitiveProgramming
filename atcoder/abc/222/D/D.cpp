/* ========================================
   ...
   * Last Modified : Sat 09 Oct 2021 02:59:43 PM CEST
...
void solve() {
  ...
  ll mxCol=3005;
// #warning TODO set back mxCol
//   ll mxCol=101;
  vector<vector<ll>> dp(N+5, vector<ll>(mxCol, 0LL));
  FOR(c0,a[0],b[0]) {
    dp[0][c0]=1LL;
  }
  ...
  ll result = std::accumulate(ALL(dp[N-1]), 0LL, [&](const auto & a, const auto & b) { return (a+b)%MOD; } );
  cout << result << endl;
}
