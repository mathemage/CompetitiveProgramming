/* ========================================
   ...
   * Last Modified : Sat 20 Nov 2021 02:35:36 PM CET
   * Created By : Karel Ha <mathemage@gmail.com>
   * URL : https://atcoder.jp/contests/abc228/standings
   * Points/Time :
   * Total/ETA : 400 pts
   * Status :
   * RE :-(
...
void solve() {
  vector<ll> A(N, -1);
  vector<ll> link(N); std::iota(ALL(link), 0);
//   vector<ll> link(N, UNDEF);
  function<ll(ll)> find = [&](ll h) {
//     LINESEP1; MSG(h);
    return h==link[h] ? h : link[h]=find(link[h]);
  };
