/* ========================================
   ...
   * Last Modified : Sat 24 Jul 2021 03:49:45 PM CEST
   ...
   * AC x20, WA x10, TLE x2 :-/ <- at least that!
   *
   ==========================================*/
...
void solve() {
  ...
  ll MAX_RES=64678;
  ll result = 0LL;
  function<void(ll, ll)> search = [&](ll redsLeft, ll nextPos=0) {
    if (result>=MAX_RES) {
#warning TODO verify the stop
      return;
    }
