/* ========================================
   ...
   * Last Modified : Sat 30 Oct 2021 02:50:18 PM CEST
...
void solve() {
  ...
  vector<ll> front(N+5); std::iota(ALL(front), 0);
  vector<ll> rear(N+5); std::iota(ALL(rear), 0);
  ll qi,x,y;
  REP(_,Q) {
    cin >> qi;
    switch (qi) {
