/* ========================================
   ...
   * Last Modified : Sat 02 Apr 2022 04:28:26 PM CEST
   * Created By : Karel Ha <mathemage@gmail.com>
   * URL : https://codingcompetitions.withgoogle.com/codejam/round/0000000000876ff1/0000000000a46471
   * Points/Time :
   * Total/ETA : 9+11 pts
   * Status :
   * S AC AC !!! Yes, that was so fast and short
   * -> 44 pts => qualified ^_^ (Everyone that scores 30 points or more once the final results are revealed will advance to Round 1.)
   *
   ==========================================*/
