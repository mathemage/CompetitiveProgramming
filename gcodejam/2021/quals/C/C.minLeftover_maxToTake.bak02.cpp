/* ========================================
   ...
   * Last Modified : Sat 27 Mar 2021 01:10:17 AM CET
...
void solve() {
  ...
  FOR(i,0,N-2) {
    ...
    int minLeftover=N-2-i;
    int maxToTake=C-minLeftover;
    MSG(minLeftover); MSG(maxToTake);

    int j = min(N-1, i+maxToTake-1);
    C -= j-i+1;
    if (C<minLeftover) {
      cout << "IMPOSSIBLE" << endl;
      return;
