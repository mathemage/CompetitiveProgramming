/* ========================================
   ...
   * Last Modified : Wed 30 Mar 2022 07:26:05 PM CEST
   * Created By : Karel Ha <mathemage@gmail.com>
   * URL : https://codingcompetitions.withgoogle.com/codejam/round/00000000000000cb/0000000000007966
   * Points/Time :
   * +12m
   * + 8m = 20m
   * + 2m = 22m
...
//   std::priority_queue<ll> q;
  ...
  ll totalDmg=std::accumulate(ALL(cost), 0LL);
  MSG(totalDmg);
  MSG(cost); LINESEP2;
  ...
  while (!q.empty()) {
    ...
    if (pos+1<N && P[pos+1]=='S') {
      std::swap(P[pos], P[pos+1]);
      std::swap(cost[pos], cost[pos+1]);
      result++;
      ...
      q.push(pos+1);
      MSG(P); MSG(cost); MSG(totalDmg); // TODO continue here
    }
  }
