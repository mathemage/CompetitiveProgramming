/* ========================================
   ...
   * Last Modified : Tue 19 Apr 2022 07:44:12 PM CEST
...
void solve() {
  ...
  ll mx=1+Q;
  vector<vector<ll>> grid2cnt(mx, vector<ll>(mx));
  ...
  MSG_VEC_VEC(grid2cnt); LINESEP1;

  FOR(x,0,Q) {
    FOR(y,0,Q) {
      if (grid2cnt[x][y]==mxCnt) {
        cout << x << " " << y << endl;
        return;
      }
    }
