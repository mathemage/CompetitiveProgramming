/* ========================================
   ...
   * Last Modified : Sun 24 Apr 2022 12:01:41 AM CEST
   * Created By : Karel Ha <mathemage@gmail.com>
   * URL : https://codingcompetitions.withgoogle.com/codejam/round/0000000000051706/000000000012295c#problem
   * Points/Time :
   * = 18m
   *
   * Total/ETA : 9+18 pts
   * Status :
   * presubmig bug <- wrong approach (on sample #3)
   *
   ==========================================*/
...
void solve() {
  ...
  MSG(up); MSG(down); MSG(right); MSG(left);
  LINESEP2;

  cout << (right<=left || count(ALL(D),'E')>count(ALL(D),'W')? right : 0) << " ";
  cout << (up<=down || count(ALL(D),'N')>count(ALL(D),'S')? up : 0) << endl;
}
