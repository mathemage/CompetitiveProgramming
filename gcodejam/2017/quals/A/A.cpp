/* ========================================
   ...
   * Last Modified : Sat 02 Apr 2022 12:26:02 AM CEST
   * Created By : Karel Ha <mathemage@gmail.com>
   * URL : https://codingcompetitions.withgoogle.com/codejam/round/00000000002017f7/0000000000201847
   * Points/Time :
   * = 9m
   *
   * Total/ETA : 5+10 pts
...
void solve() {
  ...
  ll result = 0LL;
  vector<ll> leftStarts;

  ll N=SZ(S);
  REP(pos,N) {
    ll flips = leftStarts.end() - upper_bound(ALL(leftStarts), pos-K);
