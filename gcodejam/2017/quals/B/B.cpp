/* ========================================
   ...
   * Last Modified : Pá 10. března 2023, 01:18:17
   * Created By : Karel Ha <mathemage@gmail.com>
   * URL : https://codingcompetitions.withgoogle.com/codejam/round/00000000002017f7/0000000000201878
   * Points/Time :
   * = 30m
   *
   * Total/ETA : 5+15 pts
...
void solve() {
  ...
  for (ll i = 0; i+1 < SZ(N); i += 1) {
    if (N[i]>N[i+1]) {
      N[i]--;

      ll back=i+1;
      MSG(i); MSG(back); MSG(N); LINESEP2;
      FORD(j,i-1,0) {
        MSG(j); MSG(back);
        MSG(N[j]); MSG(N[j+1]);
        LINESEP1;
