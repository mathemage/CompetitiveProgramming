/* ========================================
   ...
   * Last Modified : Thu 03 Jun 2021 12:33:42 AM CEST
   * Created By : Karel Ha <mathemage@gmail.com>
   * URL : https://codeforces.com/problemset/problem/459/B
   * Points/Time :
   *     =  7m <- search C++ reference for map::{front,back}
   * +3m = 10m
   *
   * Total/ETA :
   * Status :
...
void solve() {
  ...
  ll diff=counter.rbegin()->F - counter.begin()->F;
  cout << diff << " ";

  if (diff) {
    cout << counter.rbegin()->S * counter.begin()->S << endl;
  } else {
    cout << counter.begin()->S * (counter.begin()->S-1) / 2 << endl;
  }
}
