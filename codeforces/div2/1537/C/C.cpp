/* ========================================
   ...
   * Last Modified : Fri 18 Jun 2021 05:41:33 PM CEST
...
void solve() {
  ...
  int pos=0;
  FOR(i,bestI,n-1) { result[pos++]=h[i]; }
  FOR(i,0,bestI-1) { result[pos++]=h[i]; }
