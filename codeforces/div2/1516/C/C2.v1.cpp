...
/* ========================================
   ...
   * Last Modified : Ne 16. května 2021, 14:39:47
...
void solve() {
  ...
  MSG(a); MSG(indexOdd); LINESEP1;
  assert(indexOdd!=UNDEF);

  ll result = 1^(accumulate(ALL(a), 0)&1);
  MSG(accumulate(ALL(a), 0));
  cout << result << endl;
  if (result) {
