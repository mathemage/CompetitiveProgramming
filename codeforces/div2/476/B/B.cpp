...
/* ========================================
   ...
   * Last Modified : Pá 4. června 2021, 17:09:50
...
void solve() {
  ...
  REP(b,1<<unk) {
    ...
    MSG(b); MSG(pos); MSG(cnt); LINESEP1;
  }
  MSG(cnt);
  MSG(1<<unk);
  MSG((double)(cnt)/(double)(1<<unk));
  LINESEP1;

  cout << (double)(cnt)/(double)(1<<unk) << endl;
//   cout << std::setprecision(9) << (double)(cnt)/(double)(1<<unk) << endl;
}
