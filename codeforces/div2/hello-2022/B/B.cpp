/* ========================================
   ...
   * Last Modified : Mon 03 Jan 2022 04:17:18 PM CET
...
void solve() {
  ...
  REP(_,n) {
    ...
    ll result = pt2cost[lo]+pt2cost[hi];

    vector<ll> intvl={l,r};
    if (CONTAINS(intvl2cost, intvl)) {
      umin(intvl2cost[intvl], c);
    } else {
      intvl2cost[intvl] = c;
    }
