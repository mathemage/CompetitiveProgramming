/* ========================================
   ...
   * Last Modified : Sat 03 Jul 2021 03:25:59 PM CEST
...
void solve() {
  ll n; cin >> n;
  vector<long long> a(2*n); cin >> a;

  vector<long long> parities(2);
  for (auto & ai: a) {
    parities[ai%2]++;
  }
  MSG(parities); LINESEP1;

  bool result = parities[0]==parities[1];
