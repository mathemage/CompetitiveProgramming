/* ========================================
   ...
   * Last Modified : Thu 10 Jun 2021 04:48:20 PM CEST
...
void solve() {
  ...
  ll minPos=min_element(ALL(a))-a.begin();
  ll maxPos=max_element(ALL(a))-a.begin();
  ll l=min(minPos, maxPos)+1;
  ll r=max(minPos, maxPos)+1;
  MSG(l); MSG(r); LINESEP1;

  ll result = l+n-r+1; MSG(l+n-r+1);
  umin(result, r); MSG(r);
  umin(result, n-l+1); MSG(n-l+1);
  cout << result << endl;
}
