/* ========================================
   ...
   * File Name : E.upsolve.2.cpp
   * Creation Date : 14-04-2023
   * Last Modified : Pá 14. dubna 2023, 21:12:29
...
#define PROBLEMNAME "E.upsolve.2"
...
void solve() {
  ...
  pow9 /= 9; pow10 /= 10;
  MSG(k); MSG(pow9); MSG(pow10);
  LINESEP2; 

  string result = "";
  while (k>0 && pow9>=1 && pow10>=1) {
    LINESEP2; MSG(k);

    FOR(d,0,9) {
      LINESEP1; MSG(d);
      ll count = (d==4) ? pow10 : pow9;
      MSG(count);
