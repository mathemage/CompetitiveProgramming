/* ========================================
   ...
   * Last Modified : Thu 24 Jun 2021 12:09:24 AM CEST
   * Created By : Karel Ha <mathemage@gmail.com>
   * URL : https://codeforces.com/problemset/problem/1360/E
   * Points/Time :
   * +15-40 min of thinking
   * = 7m
   *
   * Total/ETA :
   * Status :
...
void solve() {
  ll n; cin >> n;
  vector<string> polygon(n); cin >> polygon;
  MSG(n); MSG(polygon); LINESEP1;

  REP(r,n-1) {
    REP(c,n-1) {
      if (polygon[r][c]=='1' && polygon[r][c+1]=='0' && polygon[r+1][c]=='0') {
        NO;
        return;
      }
    }
