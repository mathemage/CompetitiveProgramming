/* ========================================
   ...
   * Last Modified : Wed 30 Jun 2021 08:12:00 PM CEST
...
void solve() {
  vector<int> white(4); cin >> white;
  vector<vector<int>> black(2,  vector<int>(4)); cin >> black;
  MSG(white);
  MSG_VEC_VEC(black);
  LINESEP1;

  vector<vector<int>> intersect(2,  vector<int>(4));
  REP(i,2) {
    REP(di,4) {
