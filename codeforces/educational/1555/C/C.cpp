/* ========================================
   ...
   * Last Modified : Tue 07 Sep 2021 11:37:18 PM CEST
   * Created By : Karel Ha <mathemage@gmail.com>
   * URL : https://codeforces.com/contest/1555/my
   * Points/Time :
   * +3m
   * [+5-10m thinking]
   * +3m = 11-16m
...
void solve() {
  ll m; cin >> m;
  vector<vector<ll>> a(2, vector<ll>(m)); cin >> a;

  ll result = INF_LL;

  ll pref=0;
  ll suf=std::accumulate(ALL(a[0]), 0LL);
  REP(i,m) {
    suf-=a[0][i];
    umin(result, max(suf, pref));
    pref+=a[1][i];
  }
