/* ========================================
   ...
   * Last Modified : Sun 02 May 2021 08:45:49 PM CEST
...
void solve() {
  ...
  int result = max(l,r)-(n/2);
  auto & majorPar = (l>r ? l : r);
  auto & minorPar = (l>r ? r : l);
  auto & majorCnt = (l>r ? cntL : cntR);
  auto & minorCnt = (l>r ? cntR : cntL);
  for (auto & colCnt: majorCnt) {
    if (majorPar==minorPar) { break; }
