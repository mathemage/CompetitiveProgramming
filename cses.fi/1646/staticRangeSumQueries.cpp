/* ========================================
   ...
   ID: mathema6
   TASK: staticRangeSumQueries
   LANG: C++14

   * File Name : staticRangeSumQueries.cpp
   * Creation Date : 25-08-2021
   * Last Modified : Wed 25 Aug 2021 11:46:32 PM CEST
...
#define PROBLEMNAME "staticRangeSumQueries"
...
void solve() {
  ...
  REP(_,q) {
    cin >> a >> b;
    a--, b--;
    cout << prefSum[b]-(a-1>=0?prefSum[a-1]:0) << endl;
  }
}
