/* ========================================
   ...
   ID: mathema6
   TASK: creatingStrings
   LANG: C++14

   * File Name : creatingStrings.cpp
   * Creation Date : 03-12-2021
   * Last Modified : Fri 03 Dec 2021 10:29:43 PM CET
   * Created By : Karel Ha <mathemage@gmail.com>
   * URL : https://cses.fi/problemset/result/3194758/
   * Points/Time :
   * = 3m
   *
   * Total/ETA :
...
#include <algorithm>
#define PROBLEMNAME "creatingStrings"
