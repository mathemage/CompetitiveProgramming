/* ========================================
   ...
   * Last Modified : Thu 23 Sep 2021 11:49:31 PM CEST
   * Created By : Karel Ha <mathemage@gmail.com>
   * URL : https://contest.yandex.ru/contest/29150/problems/C/
   * Points/Time :
   *      ~ 23m
   * + 4m ~ 27m
   * +~5m ~ 32m
...
void solve() {
  ...
  REP(_,n) {
    ...
    if (SZ(centers)<2) {
      ...
      double dx0=x-centers[0].F;
      double dy0=y-centers[0].S; 
      double dx1=x-centers[1].F;
      double dy1=y-centers[1].S; 
      if (!eqDouble(dy1*dx0, dy0*dx1)) {
        result=false;
      }
    }
  }
